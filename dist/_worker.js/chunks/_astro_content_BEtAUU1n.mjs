...
import { o as objectType, h as dateType, i as arrayType, j as stringType, A as AstroError, U as UnknownContentCollectionError, c as createComponent, R as RenderUndefinedEntryError, u as unescapeHTML, a as renderTemplate, k as escape, l as renderUniqueStylesheet, n as renderScriptElement, p as createHeadAndContent, r as renderComponent } from './astro/server_DWJG0Nth.mjs';
import { r as removeBase, i as isRemotePath, p as prependForwardSlash } from './path_BgNISshD.mjs';
import { V as VALID_INPUT_FORMATS } from './consts_CBOg0Lc-.mjs';
import { u as unflatten } from './parse_F8JSOSev.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_zvwzXuK4.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://example.pages.dev", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_CEgE2BDn.mjs').then(n => n._);
